...
<head>
    ...
    <title>Admin — Operating Hours Categories</title>
    ...
    <div class="wrapper">
        <div class="side-bar">
            ...
            <div class="feature-nav"><a href="admin-operations.php">Operations</a></div>
                    ...
                    <div id="hours-container" class="main-container dashboard-page">
                        ...
                        <?php
                            ...
                            foreach ($hours as $day => $hour) {
                                ...
                                echo "<td>$day</td>";
                                echo "<td>$hour</td>";
                                echo "<td> <button onclick=\"editHours('$day', '$hour')\"> <i class='fa-solid fa-pen-to-square'></i> </button></td>"; 
                                echo "</tr>";
                            }
                        ?>
                    </tbody>    
                            ...
                            <div id="editModal" class="modal">
                                <div class="modal-content">
                                    ...
                                    <h2 id="hoursEditHead"></h2>
                                    <input type="text" id="hoursInput" name="hoursInput">
                                    <div style="display:flex;" class="editRateContainer">
                                        <div class="cancel-btn" id="cancelBtn">Cancel</div>
